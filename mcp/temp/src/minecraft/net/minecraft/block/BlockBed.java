...
public class BlockBed extends BlockDirectional {
   ...
   public BlockBed(int p_i2169_1_) {
      super(p_i2169_1_, Material.field_76253_m);
      this.func_72227_n();
   }
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      this.field_94471_cO = new Icon[]{p_94332_1_.func_94245_a(this.func_111023_E() + "_feet_top"), p_94332_1_.func_94245_a(this.func_111023_E() + "_head_top")};
      this.field_94472_b = new Icon[]{p_94332_1_.func_94245_a(this.func_111023_E() + "_feet_end"), p_94332_1_.func_94245_a(this.func_111023_E() + "_head_end")};
      this.field_94473_c = new Icon[]{p_94332_1_.func_94245_a(this.func_111023_E() + "_feet_side"), p_94332_1_.func_94245_a(this.func_111023_E() + "_head_side")};
   }
