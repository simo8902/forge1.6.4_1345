...
public class EntityReddustFX extends EntityFX {
   ...
   public EntityReddustFX(World p_i1224_1_, double p_i1224_2_, double p_i1224_4_, double p_i1224_6_, float p_i1224_8_, float p_i1224_9_, float p_i1224_10_, float p_i1224_11_) {
      ...
      this.field_70552_h = ((float)(Math.random() * 0.20000000298023224D) + 0.8F) * p_i1224_9_ * var12;
      this.field_70553_i = ((float)(Math.random() * 0.20000000298023224D) + 0.8F) * p_i1224_10_ * var12;
      this.field_70551_j = ((float)(Math.random() * 0.20000000298023224D) + 0.8F) * p_i1224_11_ * var12;
