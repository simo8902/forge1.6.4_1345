...
public class ModelBiped extends ModelBase {
   ...
   public ModelBiped(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_) {
      ...
      this.field_78114_d.func_78793_a(0.0F, 0.0F + p_i1149_2_, 0.0F);
      ...
      this.field_78112_f.func_78790_a(-3.0F, -2.0F, -2.0F, 4, 12, 4, p_i1149_1_);
      this.field_78112_f.func_78793_a(-5.0F, 2.0F + p_i1149_2_, 0.0F);
      this.field_78113_g = new ModelRenderer(this, 40, 16);
      this.field_78113_g.field_78809_i = true;
      this.field_78113_g.func_78790_a(-1.0F, -2.0F, -2.0F, 4, 12, 4, p_i1149_1_);
      this.field_78113_g.func_78793_a(5.0F, 2.0F + p_i1149_2_, 0.0F);
      this.field_78123_h = new ModelRenderer(this, 0, 16);
      this.field_78123_h.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i1149_1_);
      this.field_78123_h.func_78793_a(-1.9F, 12.0F + p_i1149_2_, 0.0F);
      this.field_78124_i = new ModelRenderer(this, 0, 16);
      this.field_78124_i.field_78809_i = true;
      this.field_78124_i.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i1149_1_);
