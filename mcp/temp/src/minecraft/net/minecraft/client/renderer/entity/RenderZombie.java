...
public class RenderZombie extends RenderBiped {
   ...
   protected int func_82429_a(EntityZombie p_82429_1_, int p_82429_2_, float p_82429_3_) {
      ...
      return super.func_130006_a(p_82429_1_, p_82429_2_, p_82429_3_);
   }
   ...
   protected ResourceLocation func_110863_a(EntityZombie p_110863_1_) {
      return p_110863_1_ instanceof EntityPigZombie?field_110866_o:(p_110863_1_.func_82231_m()?field_110864_q:field_110865_p);
   }

   protected void func_82428_a(EntityZombie p_82428_1_, float p_82428_2_) {
      this.func_82427_a(p_82428_1_);
      super.func_130005_c(p_82428_1_, p_82428_2_);
   }
   ...
   protected void func_130005_c(EntityLiving p_130005_1_, float p_130005_2_) {
      this.func_82428_a((EntityZombie)p_130005_1_, p_130005_2_);
   }

   // $FF: synthetic method
   // $FF: bridge method
   protected ResourceLocation func_110856_a(EntityLiving p_110856_1_) {
      return this.func_110863_a((EntityZombie)p_110856_1_);
   }
   ...
   protected int func_130006_a(EntityLiving p_130006_1_, int p_130006_2_, float p_130006_3_) {
      return this.func_82429_a((EntityZombie)p_130006_1_, p_130006_2_, p_130006_3_);
   }
   ...
   public void func_77101_a(EntityLivingBase p_77101_1_, double p_77101_2_, double p_77101_4_, double p_77101_6_, float p_77101_8_, float p_77101_9_) {
      this.func_82426_a((EntityZombie)p_77101_1_, p_77101_2_, p_77101_4_, p_77101_6_, p_77101_8_, p_77101_9_);
   }

   // $FF: synthetic method
   // $FF: bridge method
   protected ResourceLocation func_110775_a(Entity p_110775_1_) {
      return this.func_110863_a((EntityZombie)p_110775_1_);
   }
