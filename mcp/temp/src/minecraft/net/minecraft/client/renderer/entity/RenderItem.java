...
public class RenderItem extends Render {
      ...
      if(var10.func_77973_b() != null) {
         ...
         if(var10.func_94608_d() == 0 && var10.field_77993_c < Block.field_71973_m.length && Block.field_71973_m[var10.field_77993_c] != null && RenderBlocks.func_78597_b(Block.field_71973_m[var10.field_77993_c].func_71857_b())) {
            ...
            if(var10.func_94608_d() == 1 && var10.func_77973_b().func_77623_v()) {
               ...
               Icon var14 = var10.func_77954_c();
               if(this.field_77024_a) {
                  int var15 = Item.field_77698_e[var10.field_77993_c].func_82790_a(var10, 0);
                  var16 = (float)(var15 >> 16 & 255) / 255.0F;
                  float var17 = (float)(var15 >> 8 & 255) / 255.0F;
                  var18 = (float)(var15 & 255) / 255.0F;
                  var19 = 1.0F;
                  this.func_77020_a(p_77014_1_, var14, var13, p_77014_9_, var16 * var19, var17 * var19, var18 * var19);
               } else {
                  this.func_77020_a(p_77014_1_, var14, var13, p_77014_9_, 1.0F, 1.0F, 1.0F);
               }
            }
         }
   ...
   private void func_77020_a(EntityItem p_77020_1_, Icon p_77020_2_, int p_77020_3_, float p_77020_4_, float p_77020_5_, float p_77020_6_, float p_77020_7_) {
      ...
      float var25 = ((Icon)p_77020_2_).func_94209_e();
      float var26 = ((Icon)p_77020_2_).func_94212_f();
      float var11 = ((Icon)p_77020_2_).func_94206_g();
      float var12 = ((Icon)p_77020_2_).func_94210_h();
      float var13 = 1.0F;
      float var14 = 0.5F;
      float var15 = 0.25F;
      float var17;
      if(this.field_76990_c.field_78733_k.field_74347_j) {
         ...
         for(int var20 = 0; var20 < var24; ++var20) {
            ...
            ItemRenderer.func_78439_a(var8, var26, var11, var25, var12, ((Icon)p_77020_2_).func_94211_a(), ((Icon)p_77020_2_).func_94216_b(), var16);
