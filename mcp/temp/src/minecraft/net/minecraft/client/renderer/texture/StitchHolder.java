...
public class StitchHolder implements Comparable {
   ...
   public StitchHolder(TextureAtlasSprite p_i1276_1_) {
      this.field_98151_a = p_i1276_1_;
      this.field_94204_c = p_i1276_1_.func_94211_a();
      this.field_94201_d = p_i1276_1_.func_94216_b();
      ...
      if(this.func_94199_b() == p_94198_1_.func_94199_b()) {
         if(this.func_94197_a() == p_94198_1_.func_94197_a()) {
            if(this.field_98151_a.func_94215_i() == null) {
               return p_94198_1_.field_98151_a.func_94215_i() == null?0:-1;
            }

            return this.field_98151_a.func_94215_i().compareTo(p_94198_1_.field_98151_a.func_94215_i());
         }
