...
public class NetClientHandler extends NetHandler {
   ...
   private String func_72550_a(String p_72550_1_, String p_72550_2_, String p_72550_3_) {
      try {
         ...
         InputStream var5 = var4.openConnection(this.field_72563_h.func_110437_J()).getInputStream();
   ...
   public void func_72511_a(Packet23VehicleSpawn p_72511_1_) {
      ...
      if(p_72511_1_.field_73527_h == 10) {
         ...
         var8 = new EntityLeashKnot(this.field_72564_i, (int)var2, (int)var4, (int)var6);
         p_72511_1_.field_73528_i = 0;
         ...
         var8 = new EntityTNTPrimed(this.field_72564_i, var2, var4, var6, (EntityLivingBase)null);
   ...
   public void func_72516_a(Packet100OpenWindow p_72516_1_) {
      ...
      case 10:
         ...
         break;
      case 11:
         Entity var9 = this.func_72545_a(p_72516_1_.field_111008_f);
         if(var9 != null && var9 instanceof EntityHorse) {
            var2.func_110298_a((EntityHorse)var9, new AnimalChest(p_72516_1_.field_73430_c, p_72516_1_.field_94500_e, p_72516_1_.field_73428_d));
            var2.field_71070_bA.field_75152_c = p_72516_1_.field_73431_a;
         }
      }
   ...
   public void func_142031_a(Packet133TileEditorOpen p_142031_1_) {
      TileEntity var2 = this.field_72564_i.func_72796_p(p_142031_1_.field_142035_b, p_142031_1_.field_142036_c, p_142031_1_.field_142034_d);
      if(var2 != null) {
         this.field_72563_h.field_71439_g.func_71014_a(var2);
      } else if(p_142031_1_.field_142037_a == 0) {
         TileEntitySign var3 = new TileEntitySign();
         var3.func_70308_a(this.field_72564_i);
         var3.field_70329_l = p_142031_1_.field_142035_b;
         var3.field_70330_m = p_142031_1_.field_142036_c;
         var3.field_70327_n = p_142031_1_.field_142034_d;
         this.field_72563_h.field_71439_g.func_71014_a(var3);
      }
   ...
   public void func_72452_a(Packet42RemoveEntityEffect p_72452_1_) {
      ...
      if(var2 instanceof EntityLivingBase) {
         ((EntityLivingBase)var2).func_70618_n(p_72452_1_.field_73374_b);
      }
   }
