...
public class GuiConnecting extends GuiScreen {
   ...
   public GuiConnecting(GuiScreen p_i1182_1_, Minecraft p_i1182_2_, String p_i1182_3_, int p_i1182_4_) {
      this.field_73882_e = p_i1182_2_;
      this.field_98098_c = p_i1182_1_;
      p_i1182_2_.func_71403_a((WorldClient)null);
      this.func_74255_a(p_i1182_3_, p_i1182_4_);
   }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      this.func_73873_v_();
      if(this.field_74259_a == null) {
         this.func_73732_a(this.field_73886_k, I18n.func_135053_a("connect.connecting"), this.field_73880_f / 2, this.field_73881_g / 2 - 50, 16777215);
         this.func_73732_a(this.field_73886_k, "", this.field_73880_f / 2, this.field_73881_g / 2 - 10, 16777215);
      } else {
         this.func_73732_a(this.field_73886_k, I18n.func_135053_a("connect.authorizing"), this.field_73880_f / 2, this.field_73881_g / 2 - 50, 16777215);
