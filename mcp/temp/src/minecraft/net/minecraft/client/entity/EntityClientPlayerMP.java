...
public class EntityClientPlayerMP extends EntityPlayerSP {
   ...
   public void func_70071_h_() {
      if(this.field_70170_p.func_72899_e(MathHelper.func_76128_c(this.field_70165_t), 0, MathHelper.func_76128_c(this.field_70161_v))) {
         ...
         if(this.func_70115_ae()) {
            ...
            this.field_71174_a.func_72552_c(new Packet27PlayerInput(this.field_70702_br, this.field_70701_bs, this.field_71158_b.field_78901_c, this.field_71158_b.field_78899_d));
         } else {
            this.func_71166_b();
         }
   ...
   protected void func_110318_g() {
      this.field_71174_a.func_72552_c(new Packet19EntityAction(this, 6, (int)(this.func_110319_bJ() * 100.0F)));
   }

   public void func_110322_i() {
      this.field_71174_a.func_72552_c(new Packet19EntityAction(this, 7));
   }
