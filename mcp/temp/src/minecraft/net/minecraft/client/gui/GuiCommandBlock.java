...
public class GuiCommandBlock extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_73887_h.add(this.field_100003_c = new GuiButton(0, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 96 + 12, I18n.func_135053_a("gui.done")));
      this.field_73887_h.add(this.field_100002_d = new GuiButton(1, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 120 + 12, I18n.func_135053_a("gui.cancel")));
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      this.func_73873_v_();
      this.func_73732_a(this.field_73886_k, I18n.func_135053_a("advMode.setCommand"), this.field_73880_f / 2, 20, 16777215);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("advMode.command"), this.field_73880_f / 2 - 150, 47, 10526880);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("advMode.nearestPlayer"), this.field_73880_f / 2 - 150, 97, 10526880);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("advMode.randomPlayer"), this.field_73880_f / 2 - 150, 108, 10526880);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("advMode.allPlayers"), this.field_73880_f / 2 - 150, 119, 10526880);
