...
public class GuiStats extends GuiScreen {
   ...
   public GuiStats(GuiScreen p_i1071_1_, StatFileWriter p_i1071_2_) {
      this.field_74154_a = p_i1071_1_;
      this.field_74156_o = p_i1071_2_;
   }
   ...
   public void func_74143_g() {
      ...
      GuiButton var1;
      this.field_73887_h.add(var1 = new GuiButton(2, this.field_73880_f / 2 - 46, this.field_73881_g - 52, 100, 20, I18n.func_135053_a("stat.blocksButton")));
      GuiButton var2;
      this.field_73887_h.add(var2 = new GuiButton(3, this.field_73880_f / 2 + 62, this.field_73881_g - 52, 100, 20, I18n.func_135053_a("stat.itemsButton")));
      if(this.field_74155_n.func_77217_a() == 0) {
         var1.field_73742_g = false;
      }
   ...
   private void func_74137_c(int p_74137_1_, int p_74137_2_, int p_74137_3_) {
      ...
      field_74152_c.func_77015_a(this.field_73886_k, this.field_73882_e.func_110434_K(), new ItemStack(p_74137_3_, 1, 0), p_74137_1_ + 2, p_74137_2_ + 2);
