...
public class GuiScreenDisconnectedOnline extends GuiScreen {
   ...
   public GuiScreenDisconnectedOnline(GuiScreen p_i1108_1_, String p_i1108_2_, String p_i1108_3_, Object ... p_i1108_4_) {
      this.field_98114_n = p_i1108_1_;
      this.field_98113_a = I18n.func_135053_a(p_i1108_2_);
      this.field_98111_b = p_i1108_3_;
      this.field_98112_c = p_i1108_4_;
   }
   ...
   public void func_73866_w_() {
      ...
      this.field_73887_h.add(new GuiButton(0, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 120 + 12, I18n.func_135053_a("gui.back")));
      if(this.field_98112_c != null) {
         this.field_98110_d = this.field_73886_k.func_78271_c(I18n.func_135052_a(this.field_98111_b, this.field_98112_c), this.field_73880_f - 50);
      } else {
         this.field_98110_d = this.field_73886_k.func_78271_c(I18n.func_135053_a(this.field_98111_b), this.field_73880_f - 50);
      }
