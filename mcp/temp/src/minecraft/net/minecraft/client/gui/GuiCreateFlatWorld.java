...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_73887_h.add(this.field_82281_p = new GuiButton(2, this.field_73880_f / 2 - 154, this.field_73881_g - 52, 100, 20, I18n.func_135053_a("createWorld.customize.flat.addLayer") + " (NYI)"));
      this.field_73887_h.add(this.field_82280_q = new GuiButton(3, this.field_73880_f / 2 - 50, this.field_73881_g - 52, 100, 20, I18n.func_135053_a("createWorld.customize.flat.editLayer") + " (NYI)"));
      this.field_73887_h.add(this.field_82278_r = new GuiButton(4, this.field_73880_f / 2 - 155, this.field_73881_g - 52, 150, 20, I18n.func_135053_a("createWorld.customize.flat.removeLayer")));
