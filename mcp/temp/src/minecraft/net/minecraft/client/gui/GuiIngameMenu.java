...
public class GuiIngameMenu extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      byte var1 = -16;
      boolean var2 = true;
      this.field_73887_h.add(new GuiButton(1, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 120 + var1, I18n.func_135053_a("menu.returnToMenu")));
      if(!this.field_73882_e.func_71387_A()) {
         ((GuiButton)this.field_73887_h.get(0)).field_73744_e = I18n.func_135053_a("menu.disconnect");
      }

      this.field_73887_h.add(new GuiButton(4, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 24 + var1, I18n.func_135053_a("menu.returnToGame")));
      this.field_73887_h.add(new GuiButton(0, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 96 + var1, 98, 20, I18n.func_135053_a("menu.options")));
      GuiButton var3;
      this.field_73887_h.add(var3 = new GuiButton(7, this.field_73880_f / 2 + 2, this.field_73881_g / 4 + 96 + var1, 98, 20, I18n.func_135053_a("menu.shareToLan")));
      this.field_73887_h.add(new GuiButton(5, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 48 + var1, 98, 20, I18n.func_135053_a("gui.achievements")));
      this.field_73887_h.add(new GuiButton(6, this.field_73880_f / 2 + 2, this.field_73881_g / 4 + 48 + var1, 98, 20, I18n.func_135053_a("gui.stats")));
