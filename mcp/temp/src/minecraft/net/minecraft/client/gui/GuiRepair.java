...
public class GuiRepair extends GuiContainer implements ICrafting {
   ...
   protected void func_74189_g(int p_74189_1_, int p_74189_2_) {
      ...
      if(this.field_82327_o.field_82854_e > 0) {
         int var3 = 8453920;
         boolean var4 = true;
         String var5 = I18n.func_135052_a("container.repair.cost", new Object[]{Integer.valueOf(this.field_82327_o.field_82854_e)});
   ...
   private void func_135015_g() {
      String var1 = this.field_82326_p.func_73781_b();
      Slot var2 = this.field_82327_o.func_75139_a(0);
      if(var2 != null && var2.func_75216_d() && !var2.func_75211_c().func_82837_s() && var1.equals(var2.func_75211_c().func_82833_r())) {
         var1 = "";
      }

      this.field_82327_o.func_82850_a(var1);
      this.field_73882_e.field_71439_g.field_71174_a.func_72552_c(new Packet250CustomPayload("MC|ItemName", var1.getBytes()));
   }
