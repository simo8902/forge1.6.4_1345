...
public class GuiScreenConfigureWorld extends GuiScreen {
   ...
   public GuiScreenConfigureWorld(GuiScreen p_i1105_1_, McoServer p_i1105_2_) {
      this.field_96285_a = p_i1105_1_;
      this.field_96280_b = p_i1105_2_;
   }
   ...
   public void func_73866_w_() {
      ...
      if(this.field_96280_b.field_96404_d.equals("CLOSED")) {
         this.field_73887_h.add(this.field_96281_r = new GuiButton(0, this.field_96277_d, this.func_96264_a(12), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("mco.configure.world.buttons.open")));
         this.field_96281_r.field_73742_g = !this.field_96280_b.field_98166_h;
      } else {
         this.field_73887_h.add(this.field_96279_s = new GuiButton(1, this.field_96277_d, this.func_96264_a(12), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("mco.configure.world.buttons.close")));
         this.field_96279_s.field_73742_g = !this.field_96280_b.field_98166_h;
      }

      this.field_73887_h.add(this.field_98129_x = new GuiButton(7, this.field_96277_d + this.field_96286_n / 2 + 2, this.func_96264_a(12), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("mco.configure.world.buttons.subscription")));
      this.field_73887_h.add(this.field_96278_t = new GuiButton(5, this.field_96277_d, this.func_96264_a(10), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("mco.configure.world.buttons.edit")));
      this.field_73887_h.add(this.field_96276_u = new GuiButton(6, this.field_96277_d + this.field_96286_n / 2 + 2, this.func_96264_a(10), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("mco.configure.world.buttons.reset")));
      this.field_73887_h.add(this.field_98128_v = new GuiButton(4, this.field_96287_o, this.func_96264_a(10), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("mco.configure.world.buttons.invite")));
      this.field_73887_h.add(this.field_98127_w = new GuiButton(3, this.field_96287_o + this.field_96286_n / 2 + 2, this.func_96264_a(10), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("mco.configure.world.buttons.uninvite")));
      this.field_73887_h.add(this.field_110381_z = new GuiButton(8, this.field_96287_o, this.func_96264_a(12), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("mco.configure.world.buttons.backup")));
      this.field_73887_h.add(new GuiButton(10, this.field_96287_o + this.field_96286_n / 2 + 2, this.func_96264_a(12), this.field_96286_n / 2 - 2, 20, I18n.func_135053_a("gui.back")));
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      this.func_73732_a(this.field_73886_k, I18n.func_135053_a("mco.configure.world.title"), this.field_73880_f / 2, 17, 16777215);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("mco.configure.world.name"), this.field_96277_d, this.func_96264_a(1), 10526880);
      this.func_73731_b(this.field_73886_k, this.field_96280_b.func_96398_b(), this.field_96277_d, this.func_96264_a(2), 16777215);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("mco.configure.world.description"), this.field_96277_d, this.func_96264_a(4), 10526880);
      this.func_73731_b(this.field_73886_k, this.field_96280_b.func_96397_a(), this.field_96277_d, this.func_96264_a(5), 16777215);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("mco.configure.world.status"), this.field_96277_d, this.func_96264_a(7), 10526880);
      this.func_73731_b(this.field_73886_k, this.func_104045_j(), this.field_96277_d, this.func_96264_a(8), 16777215);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("mco.configure.world.invited"), this.field_96287_o, this.func_96264_a(1), 10526880);
