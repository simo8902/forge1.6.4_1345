...
public class GuiScreenServerList extends GuiScreen {
   ...
   public GuiScreenServerList(GuiScreen p_i1031_1_, ServerData p_i1031_2_) {
      this.field_73992_b = p_i1031_1_;
      this.field_73993_c = p_i1031_2_;
   }
   ...
   public void func_73866_w_() {
      ...
      this.field_73887_h.add(new GuiButton(0, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 96 + 12, I18n.func_135053_a("selectServer.select")));
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      this.func_73873_v_();
      this.func_73732_a(this.field_73886_k, I18n.func_135053_a("selectServer.direct"), this.field_73880_f / 2, 20, 16777215);
      this.func_73731_b(this.field_73886_k, I18n.func_135053_a("addServer.enterIp"), this.field_73880_f / 2 - 100, 100, 10526880);
