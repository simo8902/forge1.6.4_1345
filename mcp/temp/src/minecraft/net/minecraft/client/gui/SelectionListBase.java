...
public abstract class SelectionListBase {
   ...
   public SelectionListBase(Minecraft p_i1117_1_, int p_i1117_2_, int p_i1117_3_, int p_i1117_4_, int p_i1117_5_, int p_i1117_6_) {
      this.field_96622_a = p_i1117_1_;
      this.field_96616_f = p_i1117_3_;
      this.field_96627_h = p_i1117_3_ + p_i1117_5_;
      this.field_96620_b = p_i1117_6_;
      this.field_96619_e = p_i1117_2_;
      this.field_96617_g = p_i1117_2_ + p_i1117_4_;
   }
