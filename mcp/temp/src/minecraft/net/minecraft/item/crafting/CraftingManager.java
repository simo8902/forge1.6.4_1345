...
public class CraftingManager {
   ...
   private CraftingManager() {
      ...
      this.func_92103_a(new ItemStack(Item.field_111214_ch, 2), new Object[]{"~~ ", "~O ", "  ~", Character.valueOf('~'), Item.field_77683_K, Character.valueOf('O'), Item.field_77761_aM});
      ...
      this.func_92103_a(new ItemStack(Item.field_77778_at, 1, 0), new Object[]{"###", "#X#", "###", Character.valueOf('#'), Item.field_77717_p, Character.valueOf('X'), Item.field_77706_j});
      ...
      this.func_92103_a(new ItemStack(Item.field_77813_bB, 1), new Object[]{"###", "#X#", "###", Character.valueOf('#'), Item.field_77733_bq, Character.valueOf('X'), Item.field_77738_bf});
