...
public final class ItemStack {
   ...
   public List func_82840_a(EntityPlayer p_82840_1_, boolean p_82840_2_) {
      ...
      if(this.func_77942_o()) {
         NBTTagList var14 = this.func_77986_q();
         if(var14 != null) {
            for(int var7 = 0; var7 < var14.func_74745_c(); ++var7) {
               short var8 = ((NBTTagCompound)var14.func_74743_b(var7)).func_74765_d("id");
               short var9 = ((NBTTagCompound)var14.func_74743_b(var7)).func_74765_d("lvl");
   ...
   public Multimap func_111283_C() {
      ...
      if(this.func_77942_o() && this.field_77990_d.func_74764_b("AttributeModifiers")) {
         ...
         NBTTagList var2 = this.field_77990_d.func_74761_m("AttributeModifiers");
