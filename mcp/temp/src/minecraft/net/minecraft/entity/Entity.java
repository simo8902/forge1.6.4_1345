   ...
   public void func_70091_d(double p_70091_1_, double p_70091_3_, double p_70091_5_) {
      if(this.field_70145_X) {
         ...
         if(this.field_70138_W > 0.0F && var36 && (var20 || this.field_70139_V < 0.05F) && (var13 != p_70091_1_ || var17 != p_70091_5_)) {
            ...
            if(var37 * var37 + var27 * var27 >= p_70091_1_ * p_70091_1_ + p_70091_5_ * p_70091_5_) {
               p_70091_1_ = var37;
               p_70091_3_ = var25;
               p_70091_5_ = var27;
         ...
         if(this.func_70041_e_() && !var20 && this.field_70154_o == null) {
            ...
            this.field_70140_Q = (float)((double)this.field_70140_Q + (double)MathHelper.func_76133_a(var37 * var37 + var27 * var27) * 0.6D);
            this.field_82151_R = (float)((double)this.field_82151_R + (double)MathHelper.func_76133_a(var37 * var37 + var25 * var25 + var27 * var27) * 0.6D);
            if(this.field_82151_R > (float)this.field_70150_b && var32 > 0) {
               this.field_70150_b = (int)this.field_82151_R + 1;
               if(this.func_70090_H()) {
                  float var42 = MathHelper.func_76133_a(this.field_70159_w * this.field_70159_w * 0.20000000298023224D + this.field_70181_x * this.field_70181_x + this.field_70179_y * this.field_70179_y * 0.20000000298023224D) * 0.35F;
                  if(var42 > 1.0F) {
                     var42 = 1.0F;
                  }
               ...
               for(int var9 = var3; var9 <= var6; ++var9) {
                  ...
                  if(var10 > 0) {
                     try {
                        ...
                        CrashReport var12 = CrashReport.func_85055_a(var14, "Colliding entity with tile");
                        CrashReportCategory var13 = var12.func_85058_a("Tile being collided with");
                        CrashReportCategory.func_85068_a(var13, var7, var8, var9, var10, this.field_70170_p.func_72805_g(var7, var8, var9));
