...
public class MapGenRavine extends MapGenBase {
   ...
   protected void func_75045_a(long p_75045_1_, int p_75045_3_, int p_75045_4_, byte[] p_75045_5_, double p_75045_6_, double p_75045_8_, double p_75045_10_, float p_75045_12_, float p_75045_13_, float p_75045_14_, int p_75045_15_, int p_75045_16_, double p_75045_17_) {
      ...
      for(; p_75045_15_ < p_75045_16_; ++p_75045_15_) {
         double var54 = 1.5D + (double)(MathHelper.func_76126_a((float)p_75045_15_ * 3.1415927F / (float)p_75045_16_) * p_75045_12_ * 1.0F);
         double var30 = var54 * p_75045_17_;
         ...
         if(var53 || var19.nextInt(4) != 0) {
            ...
            if(p_75045_6_ >= var20 - 16.0D - var54 * 2.0D && p_75045_10_ >= var22 - 16.0D - var54 * 2.0D && p_75045_6_ <= var20 + 16.0D + var54 * 2.0D && p_75045_10_ <= var22 + 16.0D + var54 * 2.0D) {
               int var55 = MathHelper.func_76128_c(p_75045_6_ - var54) - p_75045_3_ * 16 - 1;
               int var35 = MathHelper.func_76128_c(p_75045_6_ + var54) - p_75045_3_ * 16 + 1;
               int var56 = MathHelper.func_76128_c(p_75045_8_ - var30) - 1;
               int var37 = MathHelper.func_76128_c(p_75045_8_ + var30) + 1;
               int var57 = MathHelper.func_76128_c(p_75045_10_ - var54) - p_75045_4_ * 16 - 1;
               int var39 = MathHelper.func_76128_c(p_75045_10_ + var54) - p_75045_4_ * 16 + 1;
               if(var55 < 0) {
                  var55 = 0;
               }
               ...
               if(!var58) {
                  for(var41 = var55; var41 < var35; ++var41) {
                     double var59 = ((double)(var41 + p_75045_3_ * 16) + 0.5D - p_75045_6_) / var54;

                     for(var44 = var57; var44 < var39; ++var44) {
                        double var45 = ((double)(var44 + p_75045_4_ * 16) + 0.5D - p_75045_10_) / var54;
